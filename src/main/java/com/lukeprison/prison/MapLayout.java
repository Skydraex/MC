...
public class MapLayout {
    ...
    public static final int[][] RING = {
        new int[]{-245,-245,245,-236},
        new int[]{236,-236,245,236},
        new int[]{-245,236,245,245},
        new int[]{-245,-236,-236,236},
    };
    ...
    public static final int CONCOURSE_IN = 236;
    public static final int CONCOURSE_OUT = 245;
    public static final int SHAFT_W = 7;
    public static final int RIM_W = 4;
    public static final int MINE_PLOT = 8;
    ...
    public static final Doorway[] DOORWAYS = {
        ...
        new Doorway("rim_A", "ring_N", new int[]{-166,-247,-160,-243}, "MINE"),
        new Doorway("rim_B", "ring_N", new int[]{-114,-247,-108,-243}, "MINE"),
        new Doorway("rim_C", "ring_N", new int[]{-62,-247,-55,-243}, "MINE"),
        new Doorway("rim_D", "ring_N", new int[]{-8,-247,-2,-243}, "MINE"),
        new Doorway("rim_E", "ring_N", new int[]{46,-247,53,-243}, "MINE"),
        new Doorway("rim_F", "ring_N", new int[]{102,-247,108,-243}, "MINE"),
        new Doorway("rim_G", "ring_N", new int[]{158,-247,164,-243}, "MINE"),
        new Doorway("rim_H", "ring_E", new int[]{243,-184,247,-176}, "MINE"),
        new Doorway("rim_I", "ring_E", new int[]{243,-126,247,-119}, "MINE"),
        new Doorway("rim_J", "ring_E", new int[]{243,-68,247,-60}, "MINE"),
        new Doorway("rim_K", "ring_E", new int[]{243,-8,247,-1}, "MINE"),
        new Doorway("rim_L", "ring_E", new int[]{243,52,247,59}, "MINE"),
        new Doorway("rim_M", "ring_E", new int[]{243,112,247,120}, "MINE"),
        new Doorway("rim_N", "ring_E", new int[]{243,174,247,181}, "MINE"),
        new Doorway("rim_O", "ring_S", new int[]{194,243,200,247}, "MINE"),
        new Doorway("rim_P", "ring_S", new int[]{130,243,137,247}, "MINE"),
        new Doorway("rim_Q", "ring_S", new int[]{66,243,73,247}, "MINE"),
        new Doorway("rim_R", "ring_S", new int[]{2,243,8,247}, "MINE"),
        new Doorway("rim_S", "ring_S", new int[]{-64,243,-57,247}, "MINE"),
        new Doorway("rim_T", "ring_S", new int[]{-130,243,-124,247}, "MINE"),
        new Doorway("rim_U", "ring_S", new int[]{-198,243,-191,247}, "MINE"),
        new Doorway("rim_V", "ring_W", new int[]{-247,138,-243,144}, "MINE"),
        new Doorway("rim_W", "ring_W", new int[]{-247,69,-243,76}, "MINE"),
        new Doorway("rim_X", "ring_W", new int[]{-247,0,-243,6}, "MINE"),
        new Doorway("rim_Y", "ring_W", new int[]{-247,-71,-243,-64}, "MINE"),
        new Doorway("rim_Z", "ring_W", new int[]{-247,-142,-243,-136}, "MINE"),
        new Doorway("ring_E", "ring_N", new int[]{237,-238,244,-234}, "MINE"),
        new Doorway("ring_E", "ring_S", new int[]{237,234,244,238}, "MINE"),
        new Doorway("ring_E", "shaft_H", new int[]{234,-45,238,-39}, "MINE"),
        new Doorway("ring_E", "shaft_I", new int[]{234,-33,238,-27}, "MINE"),
        new Doorway("ring_E", "shaft_J", new int[]{234,-21,238,-15}, "MINE"),
        new Doorway("ring_E", "shaft_K", new int[]{234,-9,238,-3}, "MINE"),
        new Doorway("ring_E", "shaft_L", new int[]{234,3,238,9}, "MINE"),
        new Doorway("ring_E", "shaft_M", new int[]{234,15,238,21}, "MINE"),
        new Doorway("ring_E", "shaft_N", new int[]{234,27,238,33}, "MINE"),
        new Doorway("ring_N", "ring_W", new int[]{-244,-238,-237,-234}, "MINE"),
        new Doorway("ring_N", "shaft_A", new int[]{-45,-238,-39,-234}, "MINE"),
        new Doorway("ring_N", "shaft_B", new int[]{-33,-238,-27,-234}, "MINE"),
        new Doorway("ring_N", "shaft_C", new int[]{-21,-238,-15,-234}, "MINE"),
        new Doorway("ring_N", "shaft_D", new int[]{-9,-238,-3,-234}, "MINE"),
        new Doorway("ring_N", "shaft_E", new int[]{3,-238,9,-234}, "MINE"),
        new Doorway("ring_N", "shaft_F", new int[]{15,-238,21,-234}, "MINE"),
        new Doorway("ring_N", "shaft_G", new int[]{27,-238,33,-234}, "MINE"),
        new Doorway("ring_S", "ring_W", new int[]{-244,234,-237,238}, "MINE"),
        new Doorway("ring_S", "shaft_O", new int[]{39,234,45,238}, "MINE"),
        new Doorway("ring_S", "shaft_P", new int[]{27,234,33,238}, "MINE"),
        new Doorway("ring_S", "shaft_Q", new int[]{15,234,21,238}, "MINE"),
        new Doorway("ring_S", "shaft_R", new int[]{3,234,9,238}, "MINE"),
        new Doorway("ring_S", "shaft_S", new int[]{-9,234,-3,238}, "MINE"),
        new Doorway("ring_S", "shaft_T", new int[]{-21,234,-15,238}, "MINE"),
        new Doorway("ring_S", "shaft_U", new int[]{-33,234,-27,238}, "MINE"),
        new Doorway("ring_W", "shaft_V", new int[]{-238,27,-234,33}, "MINE"),
        new Doorway("ring_W", "shaft_W", new int[]{-238,15,-234,21}, "MINE"),
        new Doorway("ring_W", "shaft_X", new int[]{-238,3,-234,9}, "MINE"),
        new Doorway("ring_W", "shaft_Y", new int[]{-238,-9,-234,-3}, "MINE"),
        new Doorway("ring_W", "shaft_Z", new int[]{-238,-21,-234,-15}, "MINE"),
